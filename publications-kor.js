var publications_kor = [
    {   'title': '물리기반 캐릭터의 축구 드리블 스킬 학습',
        ...
        'year': 2024,
        'authors': '김민수, 이윤상',
        'conference_journal_full': '한국컴퓨터그래픽스학회 2024년 학술대회 논문집, 55-56, 2024.07.',
        'additional': '<a href="https://gitcgr.hanyang.ac.kr/publications/domestic/2024-kcgs-dribble.pdf" rel="noopener noreferrer" target="_blank">[article]</a>',
        'type': 'extended_abstract',
    },
    {   'title': '시뮬레이션 되는 휴머노이드 컨트롤을 위한 잠재변수 매칭',
        'representative_img':'assets/publications/domestic/2024-kcgs-latent-matching.png',
        'year': 2024,
        'authors': '김민수, 이윤상',
    ...
    {   'title': '참조 동작을 사용하지 않는 근골격계 캐릭터의 보행 모션 학습',
        'representative_img':'assets/publications/domestic/2022-kcgs-NoRefMusculoSkeletalLocomotion.png',
        'year': 2022,
        'authors': '김민관, 이윤상',
